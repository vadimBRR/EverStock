...
export default function CardFolder({ data }: Props) {
	...
	return (
		<View
			className='w-full bg-black-700 rounded-[17px] py-3 px-4 mb-2 border border-black/10'
      ...
      <View>
        ...
        <TouchableOpacity className='flex-col ' onPress={() =>
				router.push(('/(authenticated)/(tabs)/home/folder/' + data.id) as Href)
			}>
			<Text className='font-lexend_regular text-xl text-white'>{data.name}</Text>
