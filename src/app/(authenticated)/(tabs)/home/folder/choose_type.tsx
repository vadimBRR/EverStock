	...
	return (
		<Container isPadding={false}>
			...
			<View className='mx-4 mt-2 flex-1 justify-between mb-5'>
				<View>
					<View className='rounded-2xl bg-white border   border-gray overflow-hidden '>
						<View className='flex-row justify-around  py-2 '>
							<Text className='text-lg font-lexend_semibold'>Element</Text>
							<Text className='text-lg font-lexend_semibold'>Simple</Text>
							<Text className='text-lg font-lexend_semibold'>Detailed</Text>
						</View>
						{data.map((item, index) => (
							<View
								key={item.element + index}
								className='flex-row justify-around py-2 px-4 border   border-gray'
							>
								<Text className=' flex-1 font-lexend_regular text-base'>
									{item.element}
								</Text>
								<Text className='flex-1 text-center font-lexend_regular text-lg'>
									{item.simple ? '✔' : ''}
								</Text>
								<Text className='flex-1 text-center font-lexend_regular text-lg'>
									{item.detailed ? '✔' : ''}
					...
					<View>
						<Text className='text-2xl font-lexend_light mt-4'>
							Choose Folder Type:
						</Text>
