        ...
        <View className='border border-white rounded-lg mb-2 mx-4'>
          <View className='flex-row justify-center items-center'>
            <ChooseDate
              ...
              setSelectedDate={date => handleCustomDateChange(date ?? new Date(), true)}
              isSwitchOn={true}
            />
            <Text className='text-white text-lg'>to</Text>
            <ChooseDate
              selectedDate={endDate}
              setSelectedDate={date => handleCustomDateChange(date ?? new Date(), false)}
              isSwitchOn={true}
            />
          </View>
        </View>
          ...
          <View className='w-full mt-5'>
            <View className='w-full justify-center items-center bg-black-700 h-24 rounded-xl flex flex-col'>
              ...
              <Text className='text-white text text-center font-lexend_light'>
                Try adjusting your filter or time range to see results. Or add an item to the folder
              </Text>
            </View>
          </View>
        ) : (
