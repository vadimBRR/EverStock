...
export default function RootScreen() {
  ...
  if(isAuthenticated) return <Redirect href="/(authenticated)/(tabs)/home/folder" />
	...
	return (
		<Container>
            ...
            <Text className='text-white text-xl'>{isAuthenticated ? 'You are authenticated' : 'You are not authenticated'}</Text>
