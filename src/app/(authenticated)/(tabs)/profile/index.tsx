...
export default function ProfileScreen() {
	...
	const buttons = [
		...
		},
		{
			...
			title: 'Help & Support',
			href: '/(authenticated)/(tabs)/profile/support',
		},

		{
			img: require('@/src/assets/icons/profile/logout_dark.png'),
			title: 'Logout',
			href: 'logout',
		},
	]
		...
		<Container isPadding={false}>
			...
			<View className='mt-1'>
				{buttons.map((button, index) => (
					<Pressable
						key={index}
						className='bg-black-600 w-full flex-row px-[27px] py-[16px] mb-2 items-center justify-between'
						onPress={() => {
							handlePress(button.href)
						}}
					>
						<View className='flex-row items-center'>
							<Image
								source={button.img}
								className='mr-3  w-[25px] aspect-square'
								resizeMode='contain'
							/>
						...
						<Image
							source={require('@/src/assets/icons/profile/arrow_dark.png')}
